<?php /* PUBLIC $Id: color_selector.php,v 1.1 2003/02/19 01:20:23 eddieajau Exp $ */
	...
	<form>
		...
		<!-- CUSTOMISE THE FOLLOWING COLOURS AND PRESET NAMES FOR YOUR ORGANISATIONAL NEEDS -->
			<select name="" class="text" onchange="javascript:setClose(this.options[this.selectedIndex].value)">
               ...
               <option value="FFFFCC" />In attesa di risposta</option>
               <option value="008000" />Lavoro in corso</option>
               <option value="c0c0c0" />Sospeso</option>
               <option value="ff00ff" />Terminato</option>
               <option value="FF0000" />In fase di preventivo</option>
               <option value="0000ff" />In terminazione</option> 
			</select>
		</td>
	</form>
	</tr>
