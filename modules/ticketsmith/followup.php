...
/* $Id: followup.php,v 1.7 2003/02/08 01:41:24 kobudo Exp $ */
...
if (@$followup) {
    ...
    print(">" . $AppUI->_("Return to ticket") . "</a> | <a href=index.php?m=ticketsmith>" . $AppUI->_("Return to ticket list") . "</a></td></td>\n");
    print("</tr>\n");
